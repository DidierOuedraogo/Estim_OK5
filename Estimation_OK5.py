...
# Fonctions du variogramme et krigeage
...
if uploaded_file:
    ...
    3. **Définissez les paramètres du variogramme** (effet pépite, palier, portée)
    4. **Importez une enveloppe DXF 3D** (optionnel) pour contraindre votre estimation
    5. **Créez votre modèle** et lancez l'estimation par krigeage
    
    ### 📊 Fonctionnalités clés
    
    - Krigeage ordinaire avec paramètres de variogramme configurables
